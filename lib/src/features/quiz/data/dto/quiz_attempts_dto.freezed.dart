...
mixin _$QuizAttemptsDTO {
 ...
 String get id;@JsonKey(name: 'user_id') String get userId;@JsonKey(name: 'topic_id') int get topicId; int get score;@JsonKey(name: 'total_questions') int get totalQuestions;@JsonKey(name: 'correct_answers') int get correctAnswers;@JsonKey(name: 'created_at') DateTime get createdAt;
...
@override
String toString() {
  return 'QuizAttemptsDTO(id: $id, userId: $userId, topicId: $topicId, score: $score, totalQuestions: $totalQuestions, correctAnswers: $correctAnswers, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'topic_id') int topicId, int score,@JsonKey(name: 'total_questions') int totalQuestions,@JsonKey(name: 'correct_answers') int correctAnswers,@JsonKey(name: 'created_at') DateTime createdAt
});
...
/// Create a copy of QuizAttemptsDTO
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? topicId = null,Object? score = null,Object? totalQuestions = null,Object? correctAnswers = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'topic_id')  int topicId,  int score, @JsonKey(name: 'total_questions')  int totalQuestions, @JsonKey(name: 'correct_answers')  int correctAnswers, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QuizAttemptsDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'topic_id')  int topicId,  int score, @JsonKey(name: 'total_questions')  int totalQuestions, @JsonKey(name: 'correct_answers')  int correctAnswers, @JsonKey(name: 'created_at')  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _QuizAttemptsDTO():
return $default(_that.id,_that.userId,_that.topicId,_that.score,_that.totalQuestions,_that.correctAnswers,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'topic_id')  int topicId,  int score, @JsonKey(name: 'total_questions')  int totalQuestions, @JsonKey(name: 'correct_answers')  int correctAnswers, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _QuizAttemptsDTO() when $default != null:
return $default(_that.id,_that.userId,_that.topicId,_that.score,_that.totalQuestions,_that.correctAnswers,_that.createdAt);case _:
  return null;
...
class _QuizAttemptsDTO implements QuizAttemptsDTO {
  const _QuizAttemptsDTO({required this.id, @JsonKey(name: 'user_id') required this.userId, @JsonKey(name: 'topic_id') required this.topicId, required this.score, @JsonKey(name: 'total_questions') required this.totalQuestions, @JsonKey(name: 'correct_answers') required this.correctAnswers, @JsonKey(name: 'created_at') required this.createdAt});
...
/// Create a copy of QuizAttemptsDTO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? topicId = null,Object? score = null,Object? totalQuestions = null,Object? correctAnswers = null,Object? createdAt = null,}) {
