...
class _StatisticsScreenState extends ConsumerState<StatisticsScreen> {
                      ...
                      GridView.count(
                        ...
                        children: [
                          _overviewItems(
                            color,
                            streakDay.value ??
                                0, // data.userStatsModel.streakCount,
                                  ...
                                  extra: SeeAllPageConfig(
                                    ...
                                    pageBuilder: (scrollController) {
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            data.quizAttemptsModel.length,
                                        itemBuilder: (context, index) {
                                          final quizItem =
                                              data.quizAttemptsModel[index];
                                          return _buildQuizItemForSeeAll(
                                            item: quizItem,
                                            topicList: topicList,
                                            color: color,
                                            context: context,
                                    ...
                                    onRefresh: (ref) =>
                                        ref.refresh(statisticsProvider.future),
                                  ),
                                );
                              },
                              child: Text(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            topicName,
                            style: MyTextStyle.poppinsLarge600.copyWith(
                              color: color.inverseSurface.withValues(
                                alpha: 0.8,
                              ),
                            ),
                          ),
  ...
  Widget _buildQuizItemForSeeAll({
    required QuizAttemptsModel item,
    required AsyncValue<List<TopicModel>> topicList,
    required ColorScheme color,
    required BuildContext context,
  }) {
