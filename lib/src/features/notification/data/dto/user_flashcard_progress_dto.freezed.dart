...
mixin _$UserFlashcardProgressDTO {
 ...
 String get userId;@JsonKey(name: 'flashcard_id') String get flashcardId;@JsonKey(name: 'is_learned') bool? get isLearned;@JsonKey(name: 'wrong_count') int? get wrongCount;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;
...
@useResult
$Res call({
 String userId,@JsonKey(name: 'flashcard_id') String flashcardId,@JsonKey(name: 'is_learned') bool? isLearned,@JsonKey(name: 'wrong_count') int? wrongCount,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt
});
...
/// Create a copy of UserFlashcardProgressDTO
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? flashcardId = null,Object? isLearned = freezed,Object? wrongCount = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String userId, @JsonKey(name: 'flashcard_id')  String flashcardId, @JsonKey(name: 'is_learned')  bool? isLearned, @JsonKey(name: 'wrong_count')  int? wrongCount, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserFlashcardProgressDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String userId, @JsonKey(name: 'flashcard_id')  String flashcardId, @JsonKey(name: 'is_learned')  bool? isLearned, @JsonKey(name: 'wrong_count')  int? wrongCount, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _UserFlashcardProgressDTO():
return $default(_that.userId,_that.flashcardId,_that.isLearned,_that.wrongCount,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String userId, @JsonKey(name: 'flashcard_id')  String flashcardId, @JsonKey(name: 'is_learned')  bool? isLearned, @JsonKey(name: 'wrong_count')  int? wrongCount, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _UserFlashcardProgressDTO() when $default != null:
return $default(_that.userId,_that.flashcardId,_that.isLearned,_that.wrongCount,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _UserFlashcardProgressDTO implements UserFlashcardProgressDTO {
  const _UserFlashcardProgressDTO({required this.userId, @JsonKey(name: 'flashcard_id') required this.flashcardId, @JsonKey(name: 'is_learned') this.isLearned, @JsonKey(name: 'wrong_count') this.wrongCount, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt});
...
/// Create a copy of UserFlashcardProgressDTO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? flashcardId = null,Object? isLearned = freezed,Object? wrongCount = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
