...
class _Token implements Token {
  const _Token({required this.token});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Token&&(identical(other.token, token) || other.token == token));
}
